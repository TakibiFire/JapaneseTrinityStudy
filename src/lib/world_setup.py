...
def re40_pen65_95(n_sim: int, seed: int = 42) -> Setup:
  """
  開始40歳、リタイア40歳、年金開始65歳、終了94歳末のシナリオ設定を構築します。
  """
  return create_standard_world(n_sim=n_sim,
                               start_age=40,
                               end_age_inclusive=94,
...
def _create_re40_pen65_with_mult(n_sim: int,
                                 multiplier: float,
                                 seed: int = 42) -> Setup:
  """
  開始40歳、リタイア40歳、年金開始65歳、終了94歳末で、初期支出倍率を指定したシナリオ設定を構築します。
  """
  setup = re40_pen65_95(n_sim=n_sim, seed=seed)
...
def re40_pen65_95_m0_5(n_sim: int, seed: int = 42) -> Setup:
  return _create_re40_pen65_with_mult(n_sim, 0.5, seed)


def re40_pen65_95_m0_75(n_sim: int, seed: int = 42) -> Setup:
  return _create_re40_pen65_with_mult(n_sim, 0.75, seed)


def re40_pen65_95_m1(n_sim: int, seed: int = 42) -> Setup:
  return _create_re40_pen65_with_mult(n_sim, 1.0, seed)


def re40_pen65_95_m1_5(n_sim: int, seed: int = 42) -> Setup:
  return _create_re40_pen65_with_mult(n_sim, 1.5, seed)


def re40_pen65_95_m2(n_sim: int, seed: int = 42) -> Setup:
  return _create_re40_pen65_with_mult(n_sim, 2.0, seed)
