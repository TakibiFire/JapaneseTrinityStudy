...
def main():
  ...
  for ratio in stock_ratios:
    ...
    strategies.append(
        Strategy(
            name=f"オルカン {round(ratio*100)}% (リバランスなし)",
            initial_money=10000,
            initial_loan=0,
            yearly_loan_interest=0,
    ...
    strategies.append(
        Strategy(
            name=f"オルカン {round(ratio*100)}% (毎年リバランス)",
            initial_money=10000,
            initial_loan=0,
            yearly_loan_interest=0,
            initial_asset_ratio={asset_name: ratio, rf: (1.0 - ratio)},
  ...
  # 4. 可視化と保存
  # ---------------------------------------------------------------------------
  survival_image_file = 'imgs/zero_risk_rebalance_comp_survival.svg'
  distribution_image_file = 'imgs/zero_risk_rebalance_comp_distribution.svg'
