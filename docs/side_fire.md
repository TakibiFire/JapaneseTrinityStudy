...
これまでは「あらかじめ決めた期間」働くことを前提としましたが、資産の減り具合に応じて「危険になった時だけ働く」場合はどうなるでしょうか。
...
* Zが100%でない場合は、支出の方が収入より大きいので、1~20年目でも徐々に取り崩しが発生している
...
生存確率を100%に近づけるには、以下の順序で対策を考えるのが合理的です。

まず、長く働けるスキルや単価を維持し、生涯の労働キャパシティを確保してください。今回の解析では、これが安全性の土台として最も機能することが示されています。

次に、介入のルールを決めます。資産が底をつきそうになってから慌てるのではなく、4%ルール（資産が支出の25倍）を割り込んだ段階など、余裕があるうちに柔軟に働き始めることで、運用の安定感は劇的に高まります。

## まとめ

サイドFIREは、自身の労働力をポートフォリオの調整手段として活用する戦略です。今回のシミュレーションを通じて、以下の事実が明らかになりました。

!!! success "シミュレーションから得られた知見"
    * **運用初期の就労を重視する**: 最初の5年間に生活費の一部を稼ぐだけで、50年後の生存確率は10ポイント以上改善します。運用初期の資産減少を抑えることが、長期的な複利成長を支える土台となります。
    * **早期の資産確保を目指す**: ダイナミックリバランス（DR）などの運用戦略を併用する場合、早い段階で集中して稼ぎ、運用資産を増やす「太く短く」稼ぐスタイルが、「細く長く」稼ぐよりも生存確率と資産増加の双方で有利になります。
    * **柔軟な介入基準を持つ**: 資産状況に合わせて働き始める基準（トリガー）を設定してください。資産が支出の20〜25倍（支出率4〜5%）を下回る前に働き始めることで、運用の安定感は劇的に高まります。

サイドFIREの真価は、市場が悪い時期に「資産を無理に取り崩さずに済む」という調整力にあります。この調整力を、できるだけ早い段階で、適切なルールに基づいて使うことが、長期運用の成否を分けます。
