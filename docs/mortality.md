---
description: 資産が枯渇する前に死亡する確率を考慮した「成功確率」を検証。簡易生命表に基づき、100歳まで生きる確率の低さや、死亡率をシミュレーションに組み込むことでFIREの成否がどう変わるかを多角的に分析します。
---

# 資産が枯渇する前に<wbr/>死亡するケースを考えてみる

<!--
DO NOT DELETE:
python3 src/mortality_comp_main.py
-->
