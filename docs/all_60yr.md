...
青線はダイナミックスペンディングをせず、[家計調査に基づいた支出トレンド](retired_spending.md#年齢ごとの支出の推移のグラフ)に合わせた時の年間通算支出 (=年支出-年金受給) の中央値です。60歳から年金受給が始まるため、最初から低い水準にあります。年齢とともに消費支出が減少していくトレンドを反映しています。

**赤線（ダイナミックスペンディングあり）**

赤線はダイナミックスペンディングを行った場合の中央値です。
...
25%パーセンタイル（運用が芳しくない世界線）でも、青線と同等かそれ以上の支出を維持できており、生存確率を高めながらもQOLを維持できる非常に優れた戦略と言えます。
