---
description: FIRE取り崩し期における現金（キャッシュ）リバランスの効果を検証。短期的なボラティリティ抑制には効くものの、インフレ環境下の超長期戦略では、現金へのリバランスが逆に生存確率を押し下げる要因となることを解説します。
---

# 生存確率を上げる戦略？<wbr/>現金比率をリバランスする

<!--
DO NOT DELETE:
python3 src/cash_rebalance_comp_main.py
-->

[「生存確率を上げる戦略？ 現金を持つ効果」](cash_ratio.md)の回では、初年度一括投資した際の現金比率を変えてみて、現金保有の効果を検証しました。しかし、どんなに状況が良くなったり悪くなったりしても一切アセットアロケーションの比率を変えない方針でした。
...
リバランスのたびに取得費・譲渡所得を計算し、翌年に譲渡所得税を払う設定になっています。譲渡所得を払う際にも取り崩しが発生します。
