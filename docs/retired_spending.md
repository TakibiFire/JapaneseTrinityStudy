...
<center>(86歳以上は221,056円で下げ止まると仮定してみました)</center>
...
!!! warning ""
    もちろん実際の支出は、世帯構成、性別、ローン、教育、病気などによって傾向は変わります。今回は支出の変化のパターンをシミュレーションに組み込んだ際にどれくらい影響があるのかを検証します。
