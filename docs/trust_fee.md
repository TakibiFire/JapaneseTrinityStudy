---
description: 投資信託の信託報酬がFIRE取り崩し戦略に与える影響を検証。低コストなオルカン水準なら影響は軽微ですが、1%以上の高い手数料は長期の生存確率を劇的に悪化させる致命的な要因となることを数値で示します。
---
...
<!--
DO NOT DELETE:
python3 src/trust_fee_comp_main.py
-->

これまでのシミュレーションは「リスク15%、リターン7%の金融商品」を前提としていましたが、現実の投資信託には信託報酬がかかります。取り崩し戦略で信託報酬はどれくらい重要か調べました。
