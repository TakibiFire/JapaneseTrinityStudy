---
description: FIRE取り崩しにおいて現金（キャッシュ）を保有する効果を検証。暴落時に現金を優先的に使うことで短期的な生存確率は向上しますが、20年を超える長期ではリターンの機会損失が上回るというジレンマを詳しく解説します。
---

# 生存確率を上げる戦略？<wbr/>現金を持つ効果

<!--
DO NOT DELETE:
python3 src/cash_ratio_comp_main.py
-->
