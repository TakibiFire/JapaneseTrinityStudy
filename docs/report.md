...
さらに厳しい「動的支出（上限+2%, 下限-2%）」や「動的支出（上限+2%, 下限0%）」では、破産確率がさらに下がります。変動する市場に合わせて柔軟に生活費を調整できる「柔軟なライフスタイル」こそが、リタイア後の最大のセーフティネットと言えます。

もう一つ、このアイデアがなぜ有効かと言うと「インフレ率を無視しているから」とも言えます。「世の中の物価が2%上昇しているにも関わらず自分の出費を1.5%減らす」ということを鋼の意志でできるからこそ成せる技とも言えます。
