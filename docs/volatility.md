...
!!! abstract "重要なポイント"
    ...
    * 毎年一定の利回りで増え続けるという固定リターンのシミュレーションは現実と乖離した楽観的な結果を生む。**固定リターン通りに資産が成長する確率は約30%しかなく、絶対に計画の前提にしてはいけない。**
...
左下の、y=0.0001のラインに接してしまっている部分は資産枯渇の状況です。ボラティリティ=15%の場合(水色の線)、50年の間に17%の確率で破産しているのがわかりますね。
